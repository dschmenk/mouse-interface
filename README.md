...
The left USB mouse button is mapped to the single AppleMouse II button. The right USB mouse button is mapped to a (normally non-existent) second Apple II mouse button. The middle USB mouse button is mapped to both Apple II buttons. This is supported in the [PLASMA mouse module](https://github.com/dschmenk/PLASMA/blob/master/src/inc/mouse.plh) and the [a2pi daemon](https://github.com/dschmenk/apple2pi/tree/master).
